...
public class OFTypeTest extends TestCase {
    ...
    public void testUnknown() throws Exception {
        TestCase.assertEquals(OFType.UNKNOWN, OFType.valueOf((byte) 57));
        TestCase.assertEquals(OFUnknownMessage.class, OFType.UNKNOWN
                .getInstantiable().instantiate().getClass());
    }
}
