...
public class OFActionNetworkTypeOfService extends OFAction {
     ...
     */
    public OFActionNetworkTypeOfService setNetworkTypeOfService(byte networkTypeOfService) {
    ...
    public String toString() {
        return "OFActionNetworkTypeOfService [networkTypeOfService="
                + U8.f(networkTypeOfService) + "]";
    }
}