...
public class OFActionVirtualLanPriorityCodePoint extends OFAction {
     ...
     */
    public OFActionVirtualLanPriorityCodePoint setVirtualLanPriorityCodePoint(byte virtualLanPriorityCodePoint) {
    ...
    public String toString() {
        return "OFActionVirtualLanPriorityCodePoint [virtualLanPriorityCodePoint="
                + U8.f(virtualLanPriorityCodePoint) + "]";
    }
}