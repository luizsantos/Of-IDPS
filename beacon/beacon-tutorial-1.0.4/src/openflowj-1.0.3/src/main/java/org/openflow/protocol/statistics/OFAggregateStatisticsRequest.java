...
public class OFAggregateStatisticsRequest implements OFStatistics {
     ...
     */
    public OFAggregateStatisticsRequest setMatch(OFMatch match) {
        this.match = match;
        return this;
    }
     ...
     */
    public OFAggregateStatisticsRequest setTableId(byte tableId) {
     ...
     */
    public OFAggregateStatisticsRequest setOutPort(short outPort) {
