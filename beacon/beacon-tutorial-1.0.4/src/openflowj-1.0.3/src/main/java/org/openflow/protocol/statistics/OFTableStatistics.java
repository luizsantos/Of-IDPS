...
public class OFTableStatistics implements OFStatistics {
     ...
     */
    public OFTableStatistics setName(String name) {
        this.name = name;
        return this;
    }
     ...
     */
    public OFTableStatistics setWildcards(int wildcards) {
     ...
     */
    public OFTableStatistics setMaximumEntries(int maximumEntries) {
